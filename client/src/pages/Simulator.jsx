        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
                ...
                <button
                    ...
                    className="bg-[#5B6CFF] text-white rounded-2xl p-5 text-left shadow-sm hover:shadow-md transition-all disabled:opacity-70"
                >
                ...
                <button
                    ...
                    className="bg-[#EF4444] text-white rounded-2xl p-5 text-left shadow-sm hover:shadow-md transition-all disabled:opacity-70"
                >
                ...
                <button
                    ...
                    className="bg-[#F59E0B] text-white rounded-2xl p-5 text-left shadow-sm hover:shadow-md transition-all disabled:opacity-70"
                >
                ...
                <button
                    ...
                    className="bg-[#8FAF9F] text-white rounded-2xl p-5 text-left shadow-sm hover:shadow-md transition-all disabled:opacity-70"
                >
